...
So, no strong linear correlations.  Correlations are slightly higher using rank
correlations.although weak correlations with  temperature and Salinity and
salinity and *E. coli* may never the less be meaningful, or there may be non-linear
...
with a Pareto GLM (over a fixed support of perhaps 0.5:inf, or 1:inf). The
...
(multinomial?) or quasi-binomial GLM.
...
highly skewed.  I'm not sure if the log-transformed data is heavy tailed.
